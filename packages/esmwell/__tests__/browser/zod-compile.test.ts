...
// package itself. That works in the child execution worker: esmwell's
    ...
    [
      {
        ...
        exportName: 'solve',
        args: [{ username: 'esmwell', xp: 42 }],
        expected: { username: 'esmwell', xp: 42 },
      },
      {
        name: 'compiled schema reports the same issue codes',
        exportName: 'rejects',
        args: [{ username: 'esmwell', xp: 'many' }],
